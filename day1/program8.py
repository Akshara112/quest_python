...
food_items = { 
    1 : 'Mysuru Filter Coffee', 2 : 'Yummy Idly-vada', 3 : 'Worlds soft Mysuru Mailari Dosa', 4 : 'Bhupal Special Poha', 5 : 'Bengaluru tamato-peanuts Upama' } 
...
else: print('Your ' + food_items.get(food_item_number) + ' is here') 
